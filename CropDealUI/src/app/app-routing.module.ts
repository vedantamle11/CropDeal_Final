...
import { searchedroducts } from './searched-product/searched-product.component';
...
const routes: Routes = [
  ...
  {
    path: 'CropOnSale',
    component: CropOnSaleComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'ViewYourCropOnSale',
    component: ViewYourCropsComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'Updateprofile',
  ...
  {
    path: 'ReportGenration',
    component: ReportGenrationComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'UserStatus',
    component: ChangeUserStatusComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'UserProfile',
  ...
  { path: 'searchedroducts/:id', component: searchedroducts },
